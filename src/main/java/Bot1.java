...
public class Bot1 extends Player implements Decisions{

	Bot1(int playerNum, Deck deck) {
	...
	*/
	...
	public int retrieveDiscardPile(Card fieldCard) {
		...
		for (int y = 0; y < deck.getDiscardPile().size(); y++) {
			if (deck.getDiscardPile().get(y) == fieldCard)
